...
export default function PricingPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {tiers.map((t) => {
          ...
          return (
            ...
            >
              ...
              <a
                href={t.cta.href}
                className={`mt-6 inline-flex w-full items-center justify-center rounded-lg px-4 py-2 font-medium ${t.highlight ? 'bg-blue-600 text-white hover:bg-blue-700' : 'border border-slate-300 bg-white text-slate-900 hover:bg-slate-50'}`}
              >
                {t.cta.label}
              </a>
      ...
      <div className="mt-12">
        <h2 className="text-2xl font-semibold text-center">Compare with Competitors</h2>
        <p className="text-slate-600 text-center mt-2">How SkuFlow stacks up against platforms like Deco Network.</p>
        <div className="mt-6 overflow-hidden rounded-xl border border-slate-200">
          <table className="w-full text-left bg-white">
            <thead className="bg-slate-50">
              <tr>
                <th className="px-4 py-3 text-slate-700">Feature</th>
                <th className="px-4 py-3 text-slate-700">SkuFlow</th>
                <th className="px-4 py-3 text-slate-700">Typical Competitor</th>
              </tr>
            </thead>
            <tbody>
              {[
                ...
                <tr key={row.f} className="odd:bg-white even:bg-slate-50">
