        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-6">
            <div className="rounded-xl bg-slate-800 border border-slate-700 p-8 text-center hover:bg-slate-700 hover:border-slate-600 transition-colors">
              <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-blue-100 text-blue-700 mx-auto mb-4">
                {/* design icon */}
            ...
            <div className="rounded-xl bg-slate-800 border border-slate-700 p-8 text-center hover:bg-slate-700 hover:border-slate-600 transition-colors">
              <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-indigo-100 text-indigo-700 mx-auto mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
            ...
            <div className="rounded-xl bg-slate-800 border border-slate-700 p-8 text-center hover:bg-slate-700 hover:border-slate-600 transition-colors">
              <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-rose-100 text-rose-700 mx-auto mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
